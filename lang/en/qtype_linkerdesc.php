 ...
 * @copyright  2016 Gerard Cuello  {@link http://moodle.com}
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */

// TODO: FulFill with remaining content related to global vars, etc

$string['informationtext'] = 'Information text';
$string['pluginname'] = 'Linker Description';
$string['pluginname_help'] = 'A Linker description is not really a question type. It simply enables text to be displayed without requiring any answers, similar to a label on the course page.
...
$string['pluginnameadding'] = 'Adding a Linker description';
$string['pluginnameediting'] = 'Editing a Linker description';
